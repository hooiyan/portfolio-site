---
title: Entertainment
summary: "An entertainment web app built with Next.js and TailwindCSS that allows users to search for movies and tv shows as well as viewing the relevant information."
tags: [Next, TailwindCSS, API, SWR]
hero: "../../images/preview-entertainment.jpg"
